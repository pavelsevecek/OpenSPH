...
- <a href="http://eigen.tuxfamily.org/index.php?title=Main_Page">Eigen</a> (provides additional methods for setting up initial conditions)
- <a href="https://chaiscript.com/">ChaiScript</a> (allows to read and modify particle data from a script)
- <a href="https://www.hdfgroup.org/solutions/hdf5/">HDF5</a> (allows reading files generated by <a href="https://github.com/christophmschaefer/miluphcuda">miluphcuda</a> code)
