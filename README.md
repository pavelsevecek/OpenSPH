...
The latest version can be downloaded as a <a href="https://gitlab.com/sevecekp/sph/-/jobs/artifacts/master/file/opensph_0.3.6-1.deb?job=build_package">Debian buster package</a>.
Install it via:
```
