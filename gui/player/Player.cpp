...
bool App::OnInit() {
    ...
    GuiSettings gui;
    gui.set(GuiSettingsId::ORTHO_FOV, 5.e6_f) // 4.e8_f) // 2.e5_f)
        ...
        .set(GuiSettingsId::PARTICLE_RADIUS, 1._f) // 0.35_f)
        ...
        .set(GuiSettingsId::PERSPECTIVE_POSITION, Vector(1.e6_f, 1.5e6_f, 0._f))
